...
namespace Sleepys_MorePsycasts
{
    ...
    public class SLP_MorePsycastSettings : ModSettings
    {
        ...
        public bool ToggleSLP_PSY_ArcticPinhole = true;
        public bool ToggleSLP_PSY_ImmunityBoost = true;
        public bool ToggleSLP_PSY_HealingBoost = true;
        public bool ToggleSLP_PSY_RegenMajor = true;
        public bool ToggleSLP_PSY_FlashHeal = true;
        public bool ToggleSLP_PSY_RegenMinor = true;
        public bool ToggleSLP_PSY_Resurrect = true;
        public bool ToggleSLP_PSY_CleanSkip = true;
        public bool ToggleSLP_PSY_FertilitySkip = true;
        public bool ToggleSLP_PSY_Haemostasis = true;
        public bool ToggleSLP_PSY_Ignite = true;
        public bool ToggleSLP_PSY_Recondition = true;
        public bool ToggleSLP_PSY_Interdiction = true;
        public bool ToggleSLP_PSY_WordOfSleep = true;
        public bool ToggleSLP_PSY_WordOfVigor = true;
        public bool ToggleSLP_PSY_Skipscreen = true;
        public bool ToggleSLP_PSY_PotentialUnleashed = true;
        public bool ToggleSLP_PSY_Dash = true;
        public bool ToggleSLP_PSY_WordOfContempt = true;
        public bool ToggleSLP_PSY_Calm = true;
        public bool ToggleSLP_PSY_MassBeckon = true;
        public bool ToggleSLP_PSY_MassBurden = true;
        public bool ToggleSLP_PSY_StunPulse = true;
        public bool ToggleSLP_PSY_Flashstep = true;
        public bool ToggleSLP_PSY_Skipstep = true;
        public bool ToggleSLP_PSY_ComfortShield = true;
        public bool ToggleSLP_PSY_Engulf = true;
        public bool ToggleSLP_PSY_Dart = true;
        public bool ToggleSLP_PSY_EndoPinhole = true;
        public bool ToggleSLP_SupernovaPinhole = true;
        public bool ToggleSLP_PSY_WordOfFriendship = true;
        public bool ToggleSLP_PSY_Brickgate = true;
        public bool ToggleSLP_PSY_Chemskip = true;
        public bool ToggleSLP_PSY_StaticBurst = true;
        public bool ToggleSLP_PSY_Superskip = true;

        //Conditionally Added Psycasts
        public bool ToggleSLP_PSY_Revitalise = true;
        public bool ToggleSLP_PSY_Energise = true;

        // The part that writes settings to file.
        public override void ExposeData()
        {
            Scribe_Values.Look(ref ToggleSLP_PSY_ArcticPinhole, "SLP_PSY_ArcticPinhole", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_ImmunityBoost, "SLP_PSY_ImmunityBoost", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_HealingBoost, "SLP_PSY_HealingBoost", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_RegenMajor, "SLP_PSY_RegenMajor", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_FlashHeal, "SLP_PSY_FlashHeal", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_RegenMinor, "SLP_PSY_RegenMinor", true, true);

            Scribe_Values.Look(ref ToggleSLP_PSY_Resurrect, "SLP_PSY_Resurrect", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_CleanSkip, "SLP_PSY_CleanSkip", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_FertilitySkip, "SLP_PSY_FertilitySkip", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_Haemostasis, "SLP_PSY_Haemostasis", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_Ignite, "SLP_PSY_Ignite", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_Recondition, "SLP_PSY_Recondition", true, true);

            Scribe_Values.Look(ref ToggleSLP_PSY_Interdiction, "SLP_PSY_Interdiction", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_WordOfSleep, "SLP_PSY_WordOfSleep", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_WordOfVigor, "SLP_PSY_WordOfVigor", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_Skipscreen, "SLP_PSY_Skipscreen", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_PotentialUnleashed, "SLP_PSY_PotentialUnleashed", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_Dash, "SLP_PSY_Dash", true, true);

            Scribe_Values.Look(ref ToggleSLP_PSY_WordOfContempt, "SLP_PSY_WordOfContempt", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_Calm, "SLP_PSY_Calm", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_MassBeckon, "SLP_PSY_MassBeckon", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_MassBurden, "SLP_PSY_MassBurden", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_StunPulse, "SLP_PSY_StunPulse", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_Flashstep, "SLP_PSY_Flashstep", true, true);

            Scribe_Values.Look(ref ToggleSLP_PSY_Skipstep, "SLP_PSY_Skipstep", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_ComfortShield, "SLP_PSY_ComfortShield", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_Engulf, "SLP_PSY_Engulf", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_Dart, "SLP_PSY_Dart", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_EndoPinhole, "SLP_PSY_EndoPinhole", true, true);
            Scribe_Values.Look(ref ToggleSLP_SupernovaPinhole, "SLP_SupernovaPinhole", true, true);

            Scribe_Values.Look(ref ToggleSLP_PSY_WordOfFriendship, "SLP_PSY_WordOfFriendship", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_Brickgate, "SLP_PSY_Brickgate", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_Chemskip, "SLP_PSY_Chemskip", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_StaticBurst, "SLP_PSY_StaticBurst", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_Superskip, "SLP_PSY_Superskip", true, true);

            //Conditionally Added Psycasts
            Scribe_Values.Look(ref ToggleSLP_PSY_Revitalise, "SLP_PSY_Revitalise", true, true);
            Scribe_Values.Look(ref ToggleSLP_PSY_Energise, "SLP_PSY_Engerise", true, true);
    ...
    public class SLPMorePsycast_Mod : Mod
    {
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            listingStandard.GapLine();
            listingStandard.Label("SLP_AnomalySettings".Translate());
            ...
            listingStandard.GapLine();
            listingStandard.Label("SLP_BiotechSettings".Translate());
            listingStandard.CheckboxLabeled("SLP_PSY_EnergiseExplain".Translate(), ref settings.ToggleSLP_PSY_Energise, "SLP_PSY_EnergiseTooltip".Translate());
        ...
        {
            base.WriteSettings();
            Messages.Message((string)"SLP_RestartForChanges".Translate(), MessageTypeDefOf.NegativeEvent);
            RemoveToggledPsycasts();
        }
        ...
        public void RemoveToggledPsycasts()
        {
            ...
            if (settings.ToggleSLP_PSY_Energise != true)
            {
                DefDatabase<AbilityDef>.AllDefsListForReading.Remove(SLP_PsycastDefs.SLP_PSY_Energise);
                numDisabled++;
            }
    ...
    public static class SLP_PsycastDefs
    {
        ...
        public static AbilityDef SLP_PSY_Energise;
