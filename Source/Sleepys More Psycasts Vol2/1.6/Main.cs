...
namespace Sleepys_MorePsycastsVol2
{
	...
	public class CompAbilityEffect_SLP_Gaspop : CompAbilityEffect
    {
        ...
        public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
        {
            ...
            GenExplosion.DoExplosion(target.Cell, this.parent.pawn.MapHeld, this.Props.smokeRadius, DamageDefOf.ToxGas, (Thing)null, postExplosionGasType: new GasType?(GasType.ToxGas));
        }
